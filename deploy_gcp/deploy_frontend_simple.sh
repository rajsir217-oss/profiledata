...
cat > "$PROJECT_ROOT/frontend/public/config.js" << EOF
/**
...
sed -i.bak "s@backend: process.env.REACT_APP_POD_BACKEND_URL.*@backend: process.env.REACT_APP_POD_BACKEND_URL || '$BACKEND_URL',@" "$PROJECT_ROOT/frontend/src/config/apiConfig.js"
sed -i.bak "s@api: process.env.REACT_APP_POD_API_URL.*@api: process.env.REACT_APP_POD_API_URL || '$BACKEND_URL/api/users',@" "$PROJECT_ROOT/frontend/src/config/apiConfig.js"
sed -i.bak "s@ws: process.env.REACT_APP_POD_WS_URL.*@ws: process.env.REACT_APP_POD_WS_URL || 'wss://${BACKEND_URL#https://}'@" "$PROJECT_ROOT/frontend/src/config/apiConfig.js"

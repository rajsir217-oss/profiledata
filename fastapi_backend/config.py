...
class Settings(BaseSettings):
    ...
    trusted_device_secret: str = "change-me-trusted-device-secret"
    trusted_device_app_id: str = "profiledata-web"
    ...
    profile_updated_portal_card_cooldown_minutes: Optional[int] = 60

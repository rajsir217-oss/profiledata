    ...
    async def create_poll(self, poll_data: PollCreate, created_by: str) -> Dict[str, Any]:
        ...
        try:
            ...
            poll_doc = {
                ...
                "event_type": poll_data.event_type.value if poll_data.event_type else None,
                ...
                "virtual_meet_payment_amount": poll_data.virtual_meet_payment_amount,

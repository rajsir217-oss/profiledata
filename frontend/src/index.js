...
const publicPaths = ['/', '/landing-v2', '/landing-legacy', '/login', '/register', '/register2', '/register3', '/register-interest', '/verify-email', '/verify-email-sent', '/forgot-password', '/terms', '/privacy', '/community-guidelines', '/cookie-policy', '/l3v3l-info', '/help', '/logo-showcase', '/tooltip-demo', '/messenger/public-reply'];
